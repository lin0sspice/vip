...
#ifndef H_VIPCOIN_SCRIPT
#define H_VIPCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CvipcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, vipcoin always counted CHECKMULTISIGs
