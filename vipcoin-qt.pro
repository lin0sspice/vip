...
contains(VIPCOIN_NEED_QT_PLUGINS, 1) {
    DEFINES += VIPCOIN_NEED_QT_PLUGINS
...
HEADERS += src/qt/vipcoingui.h \
    ...
    src/qt/vipcoinaddressvalidator.h \
    src/alert.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
...
SOURCES += src/qt/vipcoin.cpp src/qt/vipcoingui.cpp \
    ...
    src/qt/vipcoinaddressvalidator.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/util.cpp \
    ...
    src/qt/vipcoinstrings.cpp \
    src/qt/vipcoinamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
# also add new translations to src/qt/vipcoin.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/vipcoin_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/vipcoin-qt.rc
...
windows:RC_FILE = src/qt/res/vipcoin-qt.rc
